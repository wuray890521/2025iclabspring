...
create_library_set -name lib_min\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/SUMA180_128X16X1BM1_BC.lib\
    ${::IMEX::libVar}/mmmc/SUMA180_16384X8X1BM8_BC.lib]\
   -si\
...
create_library_set -name lib_max\
   -timing\
    ...
    ${::IMEX::libVar}/lib/typ/SUMA180_128X16X1BM1_WC.lib\
    ${::IMEX::libVar}/lib/typ/SUMA180_16384X8X1BM8_WC.lib]\
   -si\
...
create_analysis_view -name av_func_min -constraint_mode func_mode -delay_corner Delay_Corner_min
set_analysis_view -setup [list av_func_mode_max] -hold [list av_func_min]
